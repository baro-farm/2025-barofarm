...
<div class="container">
	<div class="wrapper">
		...
		<div class="content">
		    ...
		    <!-- 필터 섹션 -->
		    <form method="get" action="${contextPath }/kockFarmPostList" id="filterForm" class="filter-section">
		    <div class="filter-section">
		        ...
		        <select name="matched" id="matchedSelect">
		            <option value="all" ${param.matched == 'all' ? 'selected' : ''}>전체</option>
		            <option value="1" ${param.matched == '1' ? 'selected' : ''}>체결 완료</option>
		            <option value="0" ${param.matched == '0' ? 'selected' : ''}>체결 미완료</option>
		        </select>
		    </div>
			</form>
			<script>
