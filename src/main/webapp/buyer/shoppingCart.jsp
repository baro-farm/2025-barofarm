     ...
     전체 선택
			...
			<c:forEach var="storeEntry" items="${cartMap}">
				<div class="store-group">						
							<a href="${contextPath }/storeProductList?sellerNum=${storeEntry.value[0].sellerNum}" class="store_name"><label style="display: flex; align-items: center;"> <input type="checkbox" class="store-checkbox"
