...
<c:set var="contextPath" value="${pageContext.request.contextPath}" />
    ...
    <script>
    	$(document).ready(function() {
            ...
            <div class="title"><h3>리뷰 상세보기</h3></div>
            <p><strong>리뷰 글번호:</strong> <span id="reviewNum" name="reviewNum">${review.reviewNum}</span></p>

            <div class="reviewComment">
                <div class="reviewLeft">
					<c:if test="${not empty review.imgUrl}">
					        <img id="reviewImage" name="reviewImage" src="${contextPath}/upload/${review.imgUrl}" alt="상품 이미지">
					</c:if>                </div>
                <div class="reviewRight">
                    <p>
                        <strong>상품주문번호: </strong> 
                        <a id="orderNum" name="orderNum" href="#">${review.pdOrderNum }</a>
                    </p>
                    <p>
                        <strong>상품명:</strong> 
                        <a id="productName" name="productName" href="#">${review.productName }</a>
                    </p>
                    ...
                    <p>
                        ...
                        <span id="reviewRating" name="reviewRating">${review.pdRating }</span> | 
            ...
            <div class="sellerReply">
                <h3>판매자 답글</h3>
                <textarea id="sellerReply" name="sellerReply" placeholder="정성스러운 답글을 남겨주세요.">${review.pdComment}</textarea>
