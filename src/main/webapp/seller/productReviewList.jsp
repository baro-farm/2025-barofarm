...
<head>
    ...
    <link rel="stylesheet" href="${contextPath }/seller/productReviewList.css" />
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".reviewDetail").on("click", function (event) {
                ...
                $.ajax({
                    url: "detailReviewComment.jsp", // 올바른 경로 확인 필수!
                    method: "GET",
                    dataType: "html",
                    success: function (response) {
        ...
        <table id="notie_table" class="table" style="width: 950px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="uiGridCell productName"><a href="#">파프리카</a></div>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="uiGridCell"><img src="../../img/thumbnail.png" width="50"></div>
                    </td>
                    <td>
                        <div class="uiGridCell reviewDetail"><a href="#">파프리카가 싱싱</a></div>
                    </td>
