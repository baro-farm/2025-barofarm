...
<body>
    ...
    <div id="content">
      ...
      <form action="${contextPath }/updateProduct" id="product_form" method="POST" enctype="multipart/form-data">
        <div class="input_div">
        ...
        <div class="input_div">
          ...
          <input type="number" id="product_stock" name="product_stock" value="${product.stock }"/>
        </div>
        <div class="input_div">
          <label for="product_category">카테고리</label>
          <select name="product_category" id="product_category" value=${product.cateNum }>
        ...
        <div id="submit">
          <input type="submit" id="update_btn" value="수정하기"></input>
          <input type="submit" value="판매 중단하기" id="stop_btn" />
        </div>
      </form>
    </div>
